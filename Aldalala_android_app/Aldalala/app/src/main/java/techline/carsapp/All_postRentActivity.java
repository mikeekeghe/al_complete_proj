...
public class All_postRentActivity extends CommonAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_post_rent);
        Paper.init(this);
        ...
        rv_post_all.addOnItemTouchListener(new RecyclerTouchListener(this, rv_post_all, new RecyclerTouchListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent post_detail = new Intent(All_postRentActivity.this, Post_detailActivity.class);
    ...
    private void makeGetAllPost(int count) {
        ...
        CommonAsyTask task = new CommonAsyTask(params,
                BaseURL.GET_POST_RENT, new CommonAsyTask.VJsonResponce() {
            @Override
            public void VResponce(String response) {
                Log.e(TAG, response);
                Log.d(TAG, "Response: My_response" + response);
                ...
                if (post_modelAllList.isEmpty()) {
                    Toast.makeText(All_postRentActivity.this, getResources().getString(R.string.record_not_found), Toast.LENGTH_SHORT).show();
                }
